...
For the reading time model, the residuals versus fitted plot does not show a strong systematic pattern, suggesting that the assumption of constant variance is reasonable. The Q-Q plot indicates approximate normality of residuals with only minor deviations in the tails.
